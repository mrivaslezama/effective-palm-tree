...
import reflex as rx
from effective_palm.data import (
    line_chart_data,
    lines,
    pie_chart_data,
    area_chart_data,
...
from effective_palm.graphs import (
    area_chart,
    line_chart,
    pie_chart,
    stat_card,
...
from effective_palm.navigation import navbar
from effective_palm.template import template
